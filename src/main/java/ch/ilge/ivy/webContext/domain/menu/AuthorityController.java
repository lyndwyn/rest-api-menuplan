...
public class AuthorityController {
	 ...
	 */
	@Autowired
	public AuthorityController(MenuService menuService, MenuMapper menuMapper) {
	...
	public @ResponseBody ResponseEntity<AuthorityDTO> getById(@PathVariable long id) {
		Authority authority = menuService.findById(id).get();
		return new ResponseEntity<>(menuMapper.toDTO(authority), HttpStatus.OK);
	}
	...
	public ResponseEntity<Iterable<AuthorityDTO>> getAll() {
		List<Authority> authorities = menuService.findAll();
		return new ResponseEntity<>(menuMapper.toDTOs(authorities), HttpStatus.OK);
	}
	...
	public ResponseEntity<AuthorityDTO> create(@Valid @RequestBody AuthorityDTO authorityDTO) {
		...
		// save authority
		Authority authority = menuMapper.fromDTO(authorityDTO);
		menuService.save(authority);
		return new ResponseEntity<>(menuMapper.toDTO(authority), HttpStatus.CREATED);
	}
